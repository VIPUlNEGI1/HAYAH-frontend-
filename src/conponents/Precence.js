...
const CardSection = () => {
  return (
    <div className="p-8 text-gray-800 bg-gradient-to-b from-[#f9f9f9] to-white">
      ...
      >
        <motion.h2 className="text-3xl font-extrabold text-[#4B4E6D] mb-6 text-center" variants={fadeInUp}>
          Our Production Process
        </motion.h2>
        <motion.p className="text-lg text-center text-gray-600 mb-8" variants={fadeInUp}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {[  
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <h3 className="text-lg font-bold text-[#4B4E6D] mb-2">{step.title}</h3>
      ...
      >
        ...
        <motion.div className="max-w-4xl mx-auto" variants={fadeInUp}>
          <img
            src={img.map} // Ensure this path is correct
      ...
      >
        ...
        <motion.button
          ...
          className="bg-yellow-700 text-white px-4 py-2 rounded-md shadow-md hover:bg-yellow-800 transition-colors text-sm md:text-base"
        >
          <Link to="/contact">
            Contact Us
          </Link>
